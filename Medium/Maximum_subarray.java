    ...
    public static int maxSubArray(int[] nums) {
        ...
        for (int num : nums) {
            ...
            if (num > currSum) {
                ...
                // currSum that specifies that if you ahve added the first three elements of the array and they
                are negative so the currSum is -4 and if you add 3 to it it will be -1 and now after applying if
                condition the currSum will be 3 so the currSum will start the adding from new array element
                called as an subarray */
            }
